...
>>> a = st.sidebar.radio(\'Choose:\',[1,2])
    ...
    st.markdown('__Magic commands__')
    st.code('''
'_This_ is some __Markdown__'
a=3
'dataframe:', data
...
pip install streamlit-nightly --upgrade
    ''')
    st.markdown('<small>Learn more about [experimental features](https://docs.streamlit.io/library/advanced-features/prerelease#beta-and-experimental-features)</small>', unsafe_allow_html=True)

    st.markdown('''<hr>''', unsafe_allow_html=True)
    st.markdown('''<small>[Cheat sheet v1.25.0](https://github.com/daniellewisDL/streamlit-cheat-sheet)  | Aug 2023 | [Daniel Lewis](https://daniellewisdl.github.io/)</small>''', unsafe_allow_html=True)
